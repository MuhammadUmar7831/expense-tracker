    ...
    <div className="flex">
      <div className="h-screen py-4 px-7 border-r">
        ...
        <div className="mt-20 text-lg flex flex-col gap-6">
          <Link to="/dashboard" className="flex gap-2 px-4 py-2 hover:bg-gray-900 cursor-pointer rounded-md hover:text-white">
            <StatsIcon className="hover:text-white" />
            <span>Stats</span>
          </Link>
          <Link to="/dashboard/budget" className="flex gap-2 px-4 py-2 hover:bg-gray-900 cursor-pointer rounded-md hover:text-white">
            <BudgetIcon className="hover:text-white" />
            <span>Budgets</span>
          </Link>
          <Link to="/dashboard/expense" className="flex gap-2 px-4 py-2 hover:bg-gray-900 cursor-pointer rounded-md hover:text-white">
